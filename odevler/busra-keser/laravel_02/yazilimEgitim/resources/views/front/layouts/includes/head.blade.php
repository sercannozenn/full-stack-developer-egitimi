<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/FrontEnd/css/elegant-icons.css')}}" media="screen">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/FrontEnd/css/settings.css')}}">
    <!-- REVOLUTION LAYERS STYLES -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/FrontEnd/css/layers.css')}}">
    <!-- REVOLUTION NAVIGATION STYLES -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/FrontEnd/css/navigation.css')}}">
    ...
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.actions.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.carousel.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.migration.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.navigation.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.parallax.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/FrontEnd/js/extensions/revolution.extension.video.min.js')}}"></script>
