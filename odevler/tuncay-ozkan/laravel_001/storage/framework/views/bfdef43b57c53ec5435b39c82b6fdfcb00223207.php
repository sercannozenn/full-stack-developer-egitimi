...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Text Inputs -->
    <form action="/articles/edit/<?php echo e($data->id); ?>" method="post" class="form-horizontal form-box">
        <?php echo csrf_field(); ?>
        <h4 class="form-box-header"><?php echo e($data->articlesName); ?> Makalesini Düzenle</h4>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" id="example-input-normal" name="articlesName" class="form-control"
                           value="<?php echo e($data->articlesName); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <textarea id="example-textarea-ckeditor" name="articlesPost"
                              class="ckeditor"><?php echo e($data->articlesPost); ?></textarea>
                </div>
            </div>
            <div class="form-group">
...
<?php echo $__env->make('layouts.masterPage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tncy\Desktop\fortify\resources\views/Articles/update.blade.php ENDPATH**/ ?>