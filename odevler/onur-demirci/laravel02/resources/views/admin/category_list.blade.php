        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    ...
                    <a class="btn-floating waves-effect waves-light teal  modal-trigger" title="Yeni Kategori Ekle"
                       href="#newCategory">
                    ...
                    <table class="responsive-table">
                        ...
                        @foreach($list as $item)
                            <tr id="row{{$item->id}}">
                                <td>
                                    <a href="javascript:void(0)" class="deleteCategory" data-id="{{ $item->id }}" data-name="{{$item->name}}">
    ...
    <script>
        $(document).ready(function ()
        {
            ...
            $('.deleteCategory').click(function ()
            {
                ...
                Swal.fire({
                    title: 'Uyarı',
                    text: `${dataName} adlı kategoriyi silmek istediğinize emin misiniz?`,
                    icon: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function (response)
                            {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Uyarı',
                                    text: dataName + " adlı kategori silindi",
                                    confirmButtonText: 'Tamam'
