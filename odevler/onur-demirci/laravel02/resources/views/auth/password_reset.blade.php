...
<div class="main-wrapper">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Yazılım Eğitim Blog</p>
        </div>
    </div>
                ...
                <div class="row">
                    <form class="col s12" action="" method="POST">
                        ...
                        @if (isset($token))
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="password" type="password" name="retype">
                        ...
                        <div class="row m-t-40">
                            <div class="col s12">
                                <button class="btn-large w100 blue accent-4" type="submit">Reset Password</button>
                            </div>
                        </div>
                    </form>
                </div>
