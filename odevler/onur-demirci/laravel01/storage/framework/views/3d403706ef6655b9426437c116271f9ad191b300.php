...
<div id="page-container">
    ...
    <header class="navbar navbar-inverse">
        ...
        <!-- Logo -->
        <a href="<?php echo e(route('index')); ?>" class="navbar-brand"><img class="logo" src="<?php echo e(asset('assets/img/template/logo.png')); ?>" alt="logo"></a>
    ...
    <div id="inner-container">
        ...
        <div id="page-content">
            ...
            <ul id="nav-info" class="clearfix">
                ...
                <?php echo $__env->yieldContent('nav-info'); ?>
            </ul>
            <!-- END Navigation info -->
...
</html><?php /**PATH C:\Users\WebDev\Desktop\full-stack-developer-egitimi\odevler\onur-demirci\laravelBlog\resources\views/layouts/front.blade.php ENDPATH**/ ?>