        ...
        <div id="login-container">
            ...
            <form id="login-form" action="index.html" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <div class="input-group">
                            <input type="password" id="login-password" name="login-password" placeholder="Şifre" class="form-control">
...
</html><?php /**PATH C:\Users\WebDev\Desktop\laravelBlog\resources\views/auth/loginpage.blade.php ENDPATH**/ ?>