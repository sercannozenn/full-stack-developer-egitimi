...
<div id="login-container">
    ...
    <form id="login-form" action="index.html" method="post" class="form-horizontal">
        <h3 style="margin-block-end: unset">Kayıt Ol</h3>
        <hr style="margin-top:unset">
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    <input type="text" id="login-email" name="login-email" placeholder="İsim" class="form-control">
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    <input type="password" id="login-password" name="login-password" placeholder="Şifre"
                           class="form-control">
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    <input type="password" id="login-password" name="login-password" placeholder="Şifreyi Onayla"
                           class="form-control">
                    <span class="input-group-addon"><i class="fa fa-asterisk fa-fw"></i></span>
                </div>
            </div>
        ...
        <div class="clearfix">
            <div class="btn-group btn-group-sm pull-right">
                <button type="submit" class="btn btn-success"><i class="fa fa-arrow-right"></i> Kayıt Ol!</button>
            </div>
            <label id="topt-fixed-header-top" class="switch switch-success pull-left" data-toggle="tooltip"
                   title="Beni Hatırla"><input type="checkbox"><span></span></label>
        </div>
    </form>
    <!-- END Login Form -->
</div>
...
</html><?php /**PATH C:\Users\WebDev\Desktop\laravelBlog\resources\views/auth/registerpage.blade.php ENDPATH**/ ?>