...
<div id="login-container">
    ...
    <div id="login-buttons">
        <h5 class="page-header-sub">Kayıt İşlemleri</h5>
    </div>
    <!-- END Login Buttons -->


    <form id="register-form" action="{{route('register')}}" method="POST" class="form-horizontal">
        @csrf
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    <input type="text" id="inputName" name="name" placeholder="Ad Soyad.." class="form-control" required>
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    <input type="text" id="inputEmail" name="email" placeholder="Email.." class="form-control" required>
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    <input type="password" id="inputPassword" name="password" placeholder="Parola.." class="form-control" required>
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <div class="input-group">
                    <input type="password" id="inputPasswordConfirmation" name="password_confirmation" placeholder="Parola.." class="form-control" required>
                    <span class="input-group-addon"><i class="fa fa-asterisk fa-fw"></i></span>
                </div>
            </div>
        </div>
        <div class="clearfix">
            <div class="form-group">
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-save"></i> Kayıt Ol</button>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-xs-12">
                <a href="{{route('login')}}">Zaten bir hesabın var mı? Giriş Yap</a>
            </div>
        </div>
    </form>
    <!-- END Login Form -->
